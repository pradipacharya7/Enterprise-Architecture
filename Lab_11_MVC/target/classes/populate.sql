...
INSERT INTO  `USERS` (firstname, lastname,email, version, is_admin,rating, userid) VALUES ('Curious','George','george@curious.com',0,0,0,'admin');
INSERT INTO `USERS` (firstname, lastname,email,version,is_admin,rating,userid) VALUES ('Allen','Rench','allen@wrench.com',0,0,0,'guest');
