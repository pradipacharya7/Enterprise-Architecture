...
public class BatchJobRestart {
	 ...
	 *  Will not start skips until after first chunk of 5
	 *  uses productsRestart.csv which has 9 products
 	 *	Added 4 extra products to "activate" second chunk - 
 	 *  so restart commences at failure point - during second chunk 
	 */
	   @Autowired
...
*/
 		@Test
 	   	public void testBatchRetryFail() {
 		    ...
 		    //Since Skip retry is 3 in user-job, this will  fail as there are 4 products [ in second chunk]...	
 			// USING PrdouctItemWriteRestart as STUB so no skips n first chunk
			...
			try {
 	        ...
 	        // Since no skips in first chunk of 5...the count in the DB is 5 
